...
//             size = 1;
//             return;
//         } // если HEAD пустой, то HEAD присваиваем значение newNode, size = 1
//         Node currentNode = head;
//         while (currentNode.next != null)
//             currentNode = currentNode.next; // пока currentNode.next не равен null, переходм на след.
...
//             size--;
//             return true;
//         } // если это голова, то голова следующая Node
//         Node currentNode = head;
...
//             this.value = _value;
//             this.next = _next;
//         } // и значение и указатель на следующую Node
//     }
