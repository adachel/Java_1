// public class HashTable1<K, V> {   // К(key) - ключ; V(value) - значение
...
//     public HashTable1() {this(DEFAULT_SIZE);} // конструктор. this - это и есть HashTable

//     public HashTable1(int _size) { // конструктор от размера
